  ...
  if ($password !== $confirmar) {
    ...
    try {
      ...
      if ($consulta->rowCount() > 0) {
        ...
        $mensaje = "<div class='alert alert-success'>🎉 Registro exitoso. Ahora podés <a href='../client/login_cliente.php'>iniciar sesión</a>.</div>";
      }
    } catch (Exception $e) {
...
<head>
  ...
  width: 100%;
    ...
    .register-image {
      flex: 1;
      background: url('../client/img/HamLoginCliente.jpg') center/cover no-repeat;
    ...
    <div class="register-form-wrapper">
      <form method="post" class="register-form">
        ...
        <div class="extra-links">
          ¿Ya tenés cuenta? <a href="../client/login_cliente.php">Iniciar sesión</a><br><br>
