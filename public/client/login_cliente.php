...
<head>
  ...
  <style>
        ...
        * {
        ...
        .login-image {
          flex: 1;
          background: url('../client/img/HamLoginCliente2.jpg') center/cover no-repeat;
        }
        ...
        @media (max-width: 768px) {
          .login-container {
            ...
            height: 100%;
            background: url('../client/img/HamLoginClim,jpg') center/cover no-repeat;
  ...
  <div class="login-form-wrapper">
    <form method="post" class="login-form">
      ...
      <div class="extra-links">
        ¿No tenés cuenta? <a href="../client/registro_cliente.php">Registrate acá</a><br><br>
